	...
	<div class="text-center w-full px-4">
		...
		<div class="justify-center grid grid-cols-3 gap-2 mt-6 place-items-center w-64 mx-auto">
			<button
				...
				on:click={() => handleClick('1')}>1</button
			>
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('2')}>2</button
			>
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('3')}>3</button
			>

			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('4')}>4</button
			>
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('5')}>5</button
			>
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('6')}>6</button
			>

			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('7')}>7</button
			>
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('8')}>8</button
			>
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('9')}>9</button
			>

			<button
				type="button"
				style="width: 2rem; color: rgba(var(--color-tertiary-500) / 1); opacity: 0.8;"
				on:click={deleteLast}
			...
			<button
				type="button"
				class="btn variant-ghost-primary"
				on:click={() => handleClick('0')}>0</button
			>
